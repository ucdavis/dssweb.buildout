...
logger = logging.getLogger('dss.portlet.person')
...
class Assignment(base.Assignment):
    ...
    header = _(u"title_person_portlet", default=u"Person portlet")
    omit_border = True
    footer = u""
    more_url = ''
    ...
    def title(self):
        ...
        """
        return self.header or _(u'portlet_person', default=u"Person Portlet")
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('person.pt')
