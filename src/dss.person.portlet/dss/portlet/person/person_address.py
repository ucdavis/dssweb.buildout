...
logger = logging.getLogger('dss.portlet.person_address')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(IPersonAddressPortlet)
    label = _(u"title_add_person_address_portlet", default=u"Add person address portlet")
    description = _(u"person_address_portlet",
...
class EditForm(base.EditForm):
    ...
    """
    form_fields = form.Fields(IPersonAddressPortlet)
    label = _(u"title_edit_person_address_portlet", default=u"Edit person address portlet")
