...
def setup_product():
    ...
    import Products.IssEvent
    zcml.load_config('configure.zcml', Products.IssEvent)
    ...
    ztc.installPackage('Products.IssEvent')
...
setup_product()
ptc.setupPloneSite(products=['Products.IssEvent'])
